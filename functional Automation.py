...
list= []
actual_list = driver.find_elements(By.XPATH, "//div[@class= 'products']/div[@class='product']/h4[@class='product-name']")
...
final_amount = float(driver.find_element(By.CSS_SELECTOR, ".discountAmt").text)
assert sum == totalAmount
assert totalAmount >= final_amount
